...
-(void)setImage_url:(NSString *)image_url {//
    [self.image sd_setImageWithURL:[NSURL URLWithString:image_url] placeholderImage:[UIImage imageNamed:@"LoadingFailed_Image"] options:SDWebImageAllowInvalidSSLCertificates];
}
