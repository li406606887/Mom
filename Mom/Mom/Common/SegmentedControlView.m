...
-(UIView *)segmentedView{
    if (!_segmentedView) {
        _segmentedView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kWidth, kHeight)];
...
-(void)setSelectedBackgroundColor:(UIColor *)selectedBackgroundColor {
    for ( UIButton *btn in self.btnArray) {
        [btn setBackgroundColorImage:selectedBackgroundColor forState:UIControlStateSelected];
    }
}

-(void)setDefultBackgroundColor:(UIColor *)defultBackgroundColor {
    for ( UIButton *btn in self.btnArray) {
        [btn setBackgroundColorImage:defultBackgroundColor forState:UIControlStateNormal];
    }
}
