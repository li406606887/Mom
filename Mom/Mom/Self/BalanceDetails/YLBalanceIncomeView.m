...
@interface YLBalanceIncomeView ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation YLBalanceIncomeView
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.viewModel.inDataArray.count;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.viewModel.inDataArray.count > indexPath.row){
        YLBalanceDetailsModel * model = [YLBalanceDetailsModel mj_objectWithKeyValues:self.viewModel.inDataArray[indexPath.row]];
...
-(void)requestDataList {
    ...
    [self.viewModel.getInDateCommand execute:input];
