...
@interface YLBalanceDetailsAllView ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation YLBalanceDetailsAllView
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.viewModel.allDataArray.count > indexPath.row){
        YLBalanceDetailsModel * model = [YLBalanceDetailsModel mj_objectWithKeyValues:self.viewModel.allDataArray[indexPath.row]];
...
-(void)requestDataList {
    ...
    [self.viewModel.getDateCommand execute:input];
