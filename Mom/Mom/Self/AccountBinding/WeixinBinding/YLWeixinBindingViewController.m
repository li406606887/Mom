//
//  YLWeixinBindingViewController.m
//  Mom
//
...
@interface YLWeixinBindingViewController ()
...
@implementation YLWeixinBindingViewController
...
//    wechatAccount alipayAccount type 类型((1.支付宝账户;2.微信账户;)
    ...
    [input setObject:self.textField.text forKey:@"wechatAccount"];
