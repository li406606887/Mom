...
@implementation MyBabyTableViewCell
...
- (void)setModel:(BabyModel *)model {
    ...
    self.birthDate.text = [NSString stringWithFormat:@"出生(或预产期):%@",[NSDate changeDateWithdate:model.babyBirthday]];
}
