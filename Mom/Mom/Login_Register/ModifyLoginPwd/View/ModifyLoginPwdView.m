...
-(instancetype)initWithViewModel:(id<BaseViewModelProtocol>)viewModel {
    self.viewModel = (ModifyLoginPwdViewModel *)viewModel;
...
- (UIButton *)login {
    if (!_login) {
        ...
        [_login setTitle:@"保存新密码" forState:UIControlStateNormal];
        ...
        [[_login rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(__kindof UIControl * _Nullable x) {
            ...
            NSDictionary *param = @{@"oldPassword":self.oldPwdField.text,@"password":self.surePwdField.text};
